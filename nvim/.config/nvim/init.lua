...
require('lazy').setup {
  ...
  { 'numToStr/Comment.nvim', opts = { mappings = { extra = false } } },
      ...
      local servers = {
        pyright = {
          settings = {
            ...
            python = {
              venvPath = '.venv', -- Use the virtual environment in the current directory
              -- pythonPath = '.venv',
              analysis = {
...
-- Tomas custom additions (likely from LazyVim)
